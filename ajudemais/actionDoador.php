        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    $inserirDoador = "INSERT INTO Doadores (cpf, nome, email, senha, data_nascimento, endereco, telefone, FOTO) VALUES ('$cpfDoador','$nomeDoador', '$emailDoador','$senhaDoador','$dataNascimentoDoador', '$cidadeDoador', '$telefoneDoador', '$fotoDoador')";
