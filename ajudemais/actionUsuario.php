    ...
    <div class="container mt-3 mb-3">
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                $cpfUsuario = $nomeUsuario = $dataNascimentoUsuario = $cidadeUsuario = $telefoneUsuario = $emailUsuario = $senhaUsuario = $confirmarSenhaUsuario = "";
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    $inserirUsuario = "INSERT INTO usuario (cpf, nome, email, senha, data_nascimento, endereco, telefone, FOTO) VALUES ('$cpfUsuario','$nomeUsuario', '$emailUsuario','$senhaUsuario','$dataNascimentoUsuario', '$cidadeUsuario', '$telefoneUsuario', '$fotoUsuario')";
